...
class Unparser : public ParseTreeVisitor {
 public:
  ...
  void visitASTCreateIndexStatement(const ASTCreateIndexStatement* node,
                                    void* data) override;
  void visitASTCreateUserStatement(const ASTCreateUserStatement* node,
                                    void* data) override;
  void visitASTDropUserStatement(const ASTDropUserStatement* node,
                                    void* data) override;
  ...
  void visitASTShowStatement(const ASTShowStatement* node,
                             void* data) override;
  void visitASTTargetName(const ASTTargetName* node,
                             void* data) override;
  ...
  void visitASTConfigClause(const ASTConfigClause* node, void* data) override;
  ...
  void visitASTAlterDatabaseStatement(const ASTAlterDatabaseStatement* node,
                                      void* data) override;
  void visitASTAlterUserStatement(const ASTAlterUserStatement* node,
                                    void* data) override;
